    ...
    def die(self, entities):
        ...
        if not self.dying:
            ...
            if (price_stick <= amount_stick and price_rock <= amount_rock and
                ...
                for _ in range(price_stick): generation.removeItemFromInventory("Stick")
                for _ in range(price_rock): generation.removeItemFromInventory("Rock")
                for _ in range(price_mushroom): generation.removeItemFromInventory("Mushroom_juice")
                for _ in range(price_mirror): generation.removeItemFromInventory("Mirror")
                self.dying = True
